FUNCTION(LIP_SYNC_extract_version)
    ...
    STRING(REGEX MATCH "BASIC_VER_MINOR ([0-9]+)" _  "${file_contents}")
    IF(NOT CMAKE_MATCH_COUNT EQUAL 1)
        MESSAGE(FATAL_ERROR "Could not extract minor version number from version.hpp")
    ENDIF()
    SET(ver_minor ${CMAKE_MATCH_1})
    STRING(REGEX MATCH "BASIC_VER_PATCH ([0-9]+)" _  "${file_contents}")
    IF(NOT CMAKE_MATCH_COUNT EQUAL 1)
        MESSAGE(FATAL_ERROR "Could not extract patch version number from version.hpp")
    ENDIF()
    SET(ver_patch ${CMAKE_MATCH_1})

    SET(LIP_SYNC_VERSION_MAJOR ${ver_major} PARENT_SCOPE)
    SET (LIP_SYNC_VERSION "${ver_major}.${ver_minor}.${ver_patch}" PARENT_SCOPE)
ENDFUNCTION()
